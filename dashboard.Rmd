...
Is there a "curse of the weekend?" i.e. hardly any weight loss or even a weight gain on Monday or Tuesday following some indiscretions over the weekend?
...
The charts on the left represent the change in all the biometric markers we are tracking on a daily basis using a weighing scale which syncs to the phone via bluetooth and thus allows us to easily collect these numbers. We then download these numbers directly from their website and do the analysis here.
